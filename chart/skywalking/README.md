...
| `ui.image.tag`                         | Horizon UI image tag (required), e.g. `horizon-1.0.0`                                                                                                                                                                                                                                                                      | `null`                                                                                                                   |
...
| `ui.readinessProbe`                    | HTTP readiness probe; verifies the BFF is up and OAP query port is reachable                                                                                                                                                                                                                                               | `httpGet.path: /api/oap/info, port: 8081`                                                                                |
